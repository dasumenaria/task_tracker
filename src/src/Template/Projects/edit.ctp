			...
			<?php  echo $this->Form->create($project, ['type' => 'file','id'=>"UserRegisterForm"]); ?>
				<div class="box-body"> 
					<div class="form-group col-md-6">
						...
						<input type="text" class="form-control" value="<?php echo $project->title;?>" name="title" id="title" placeholder="Enter project title">
					</div>
					<div class="form-group col-md-6">
						<label>Deadline</label>
						<input type="text" value="<?php echo date('d-m-Y',strtotime($project->deadline));?>" class="form-control date-picker" data-date-format="dd-mm-yyyy" name="deadline" id="deadline" placeholder="Enter deadline">
					</div>
					<div class="form-group col-md-6">
